...
st.write("Find out how much you will need approximately for buying a flat in the respective towns.")
# read data
...
points = alt.Chart(filtered).mark_point(filled=True, size=200).encode(
    x=alt.X('median(resale_price):Q',
            scale=alt.Scale(domain=[filtered_groupby_resale_min, filtered_groupny_resale_max])),
    y=alt.Y('town:O'),
